...
class TestSettings(TransactionProcessorTestCase):
    ...
    def test_vote_approved(self):
        ...
        self._expect_get(
            ...
            f'{self._public_key},some_other_public_key',
        )
    ...
    def test_vote_counted(self):
        ...
        self._expect_get(
            'sawtooth.settings.vote.authorized_keys',
            f'{self._public_key},some_other_public_key,third_public_key',
        )
    ...
    def test_vote_rejected(self):
        ...
        self._expect_get(
            'sawtooth.settings.vote.authorized_keys',
            f'{self._public_key},some_other_public_key,a_rejectors_public_key',
        )
